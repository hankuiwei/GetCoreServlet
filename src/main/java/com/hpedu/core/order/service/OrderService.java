package com.hpedu.core.order.service;
...
public interface OrderService {
	 ...
	 * 
	 * */
	/*Page<Order>  findOrderListByPage(Map<String, String> map,int pageNo,int pageSize) throws Exception;*/
	List<Order>  findOrderListByPage(int pageno,int pagesize) throws Exception;
