package com.hpedu.core.user.service;
...
public interface UserService {
	 ...
	 * 
	 * */
	Page<User> searchUserList(Map<String,String> map,int pageNo,int pageSize)throws Exception;
	...
	List<Map>  findlearnListByPage(String userId,int pageno, int pagesize) throws Exception;
	 ...
	 * @param map集合
	 * */
	Page searchUnitTestList(Map<String,Object> map,int pageno,int pagesize)throws Exception;
	     /**
		 * 学生简答题得分详情
		 * */
		...
		String[] getNewYQCode(int codeLen,HttpServletRequest request, String uploadAbsolutePath);//获取新邀请码
