...
public class PayConfigUtil {
	/**这个密钥 是想要的那个吗?--?暂时不需要*/
//	public static final String APP_SECRET = "ef0cc54cb2676ab7f24391443a6e5794";
...
//    private static String ip = "127.0.0.1";  //测试使用
   ...
   //private static String WEB_SERVICE_PATH = "http://157i04614c.imwork.net/edu";//测试使用
    private static String WEB_SERVICE_PATH = "http://123.57.224.170/GetCoreServlet";
    ...
    //回调地址  
    public static String NOTIFY_URL = ""; //测试  -- 回调地址需完善 ???
