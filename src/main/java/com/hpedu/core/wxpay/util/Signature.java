...
//        result += "&key=AQuickBrownFoxJumpsOverALazyDog1"; //+ Configure.getKey();
	...
	public static Map<String,String> get_Signature(String url_path) throws IOException{
		 ...
		 java.util.Properties pro=BaseUtil.readPorpertites("application.properties");
		 ...
		 Map<String,Object> mymap1=JSONObject.parseObject( HttpClient.httpGet(url), Map.class);
		 String access_token=(String) mymap1.get("access_token");
		
		//获取临时票据
		url="https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token="+access_token+"&type=jsapi";
		mymap1=JSONObject.parseObject( HttpClient.httpGet(url), Map.class);
        ...
        System.out.println("ccccc================"+net.sf.json.JSONObject.fromObject(map).toString());
        return map;
    }
