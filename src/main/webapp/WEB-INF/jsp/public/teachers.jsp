...
<div class="content">
	<div id="person_show" class="model">
	    <header>
	        <h4 class="model_head_second"><span class="underline">名师推荐</span></h4>
	    </header>
	    <div id="person_show_body" class="model_body_flex" style="margin-bottom:1rem;">
	    	<c:forEach items="${ pages.result}" var="teacher">
	    	 	<div class="every_person" style="height:6.2rem">
		            ...
		            <a href="javascript:void(0);" class="person_img">
		            	<img src="${teacher.timgUrl}" class="info_img" alt="">
		            </a>
		            <p class="person_name_char" style="margin-top:0.1rem">${teacher.tname}</p>
...
<script type="text/javascript">
	function pageSize(num){
		teacher_list("public/teachers",num);
	}
